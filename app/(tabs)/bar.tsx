    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.center}>
          ...
          <Text style={[styles.title, { color: colors.text }]}>My Bar — coming in Screen 5</Text>
          <Text style={[styles.subtitle, { color: colors.textDim }]}>Grid of owned bottles, snap-to-add FAB,{'\n'}and inventory management.</Text>
        </View>
      </SafeAreaView>
    </View>
  );
